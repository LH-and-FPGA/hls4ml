...
#include "hey_jarvis_primary.h"
#include "parameters.h"


void hey_jarvis_primary(
    input_t x[1536],
    ...
    if (!loaded_weights) {
        nnet::load_weights_from_txt<fc1_weight_t, 196608>(w2, "w2.txt");
        nnet::load_weights_from_txt<fc1_bias_t, 128>(b2, "b2.txt");
        nnet::load_weights_from_txt<ln1_scale_t, 128>(s3, "s3.txt");
        nnet::load_weights_from_txt<ln1_bias_t, 128>(b3, "b3.txt");
        nnet::load_weights_from_txt<fc2_weight_t, 16384>(w5, "w5.txt");
        nnet::load_weights_from_txt<fc2_bias_t, 128>(b5, "b5.txt");
        nnet::load_weights_from_txt<ln2_scale_t, 128>(s6, "s6.txt");
        nnet::load_weights_from_txt<ln2_bias_t, 128>(b6, "b6.txt");
        nnet::load_weights_from_txt<fc3_weight_t, 128>(w8, "w8.txt");
    ...
    fc2_result_t layer5_out[128];
    #pragma HLS ARRAY_PARTITION variable=layer5_out complete dim=0

    layer6_t layer6_out[128];
    #pragma HLS ARRAY_PARTITION variable=layer6_out complete dim=0

    layer7_t layer7_out[128];
