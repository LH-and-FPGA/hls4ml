#ifndef HEY_JARVIS_VERIFIER_BRIDGE_H_
#define HEY_JARVIS_VERIFIER_BRIDGE_H_

#include "firmware/hey_jarvis_verifier.h"
...
void hey_jarvis_verifier_float(
    float *x,
    float *layer9_out
) {
    ...
    hey_jarvis_verifier(x_ap,layer9_out_ap);

    nnet::convert_data<result_t, float, 1>(layer9_out_ap, layer9_out);
}

void hey_jarvis_verifier_double(
    double *x,
    double *layer9_out
) {
